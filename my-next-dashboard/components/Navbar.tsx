  ...
  return (
    <nav className="flex justify-between items-center px-6 py-3 bg-gradient-to-r from-indigo-600 via-primary-600 to-indigo-500 text-white shadow-lg sticky top-0 z-50">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/20 font-bold">SD</div>
        <div>
          <div className="font-extrabold text-lg">Smart Dashboard</div>
          <div className="text-xs text-white/80">Track tasks & productivity</div>
        </div>
      </div>
